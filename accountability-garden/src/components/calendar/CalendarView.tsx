...
export const CalendarView: React.FC<CalendarViewProps> = ({ commitments, records }) => {
  ...
  // Month navigation (Defaults to September 2026)
  const [currentYear, setCurrentYear] = useState<number>(2026);
  const [currentMonth, setCurrentMonth] = useState<number>(8); // 8 = September (0-indexed)

  const [inspectedDate, setInspectedDate] = useState<string>('2026-09-17');
      ...
      <div className="calendar-grid-card">
        ...
        <div className="calendar-cells-grid">
          {calendarDays.map(cell => {
            const isToday = cell.dateStr === '2026-09-17';
            ...
            relevantCommitments.forEach(c => {
              ...
              if (isHabitScheduledOnDate(c, cell.dateStr)) {
                ...
                } else if (cell.dateStr < '2026-09-17') {
                  missedCount++;
                }
              }
            });
