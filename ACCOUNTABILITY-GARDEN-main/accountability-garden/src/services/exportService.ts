...
export class ExportService {
  ...
  public static downloadJSON(data: LifeLogExport, filename?: string): void {
    ...
    a.href = url;
    a.download = filename || `AccountabilityGarden_LifeLog_${getLocalDateString()}.json`;
  ...
  public static downloadRecordsCSV(data: LifeLogExport): void {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = `AccountabilityGarden_Records_${getLocalDateString()}.csv`;
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
    URL.revokeObjectURL(url);
  ...
  public static downloadMarkdownReport(data: LifeLogExport): void {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = `AccountabilityGarden_Report_${getLocalDateString()}.md`;
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
    URL.revokeObjectURL(url);
