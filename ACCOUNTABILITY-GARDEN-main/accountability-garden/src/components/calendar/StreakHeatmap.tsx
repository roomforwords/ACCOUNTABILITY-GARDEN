...
export const StreakHeatmap: React.FC<StreakHeatmapProps> = ({
  ...
  const activeReferenceDateStr = referenceDateStr || getLocalDateString();
  const [selectedCell, setSelectedCell] = useState<HeatmapCell | null>(null);

  const cells = React.useMemo(() => {
    return generateHeatmapGrid(commitment, records, daysCount, activeReferenceDateStr);
  }, [commitment, records, daysCount, activeReferenceDateStr]);
